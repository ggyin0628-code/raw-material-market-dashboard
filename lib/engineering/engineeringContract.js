...
function getEngineeringEstimateSchema() {
  return {
    ...
    output: {
      ...
      processTimeEstimate: {
        states: ["CALIBRATION_REQUIRED", "CALCULATED", "DISABLED", "NO_MODEL"],
        timeUnit: "min",
        publicDefault: "CALIBRATION_REQUIRED",
        note: "未提供受核准校正 profile 時不猜測速度、setup、操作效率或表面處理時間。",
      },
      monetaryFieldsWithNoRate: null,
      marketAdjustmentFactor: null,
      privateCostExposure: "DENY_ANONYMOUS_PUBLIC_API",

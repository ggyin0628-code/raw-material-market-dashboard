...
function createProtectedPrivateCostResponse({ baseEstimate, input, profile, authorization, auditLogger, estimateId }) {
  return createProtectedPrivateCostEstimate({ baseEstimate, input, profile, authorization, auditLogger, estimateId });
}

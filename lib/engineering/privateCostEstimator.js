...
function createProtectedPrivateCostEstimate({ baseEstimate, input, profile, authorization, auditLogger }) {
  ...
  auditLogger({
    event: "PRIVATE_COST_ESTIMATE",
    decision: "APPROVED",
    subject: authorization.subject || "authenticated-private-runtime",
    scope: PRIVATE_SCOPE,
    rateProfileId: profile.rateProfileId,
    rateProfileVersion: profile.version,

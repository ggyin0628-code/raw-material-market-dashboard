...
const CURRENCY_EVIDENCE_VALUES = Object.freeze(["EXPLICIT", "LOCALE_INFERRED", "UNKNOWN"]);
...
function record(fields) {
  return Object.freeze({
    ...
    currencyEvidence: fields.currencyEvidence || "UNKNOWN",
    currencyEvidenceNote: fields.currencyEvidenceNote || "來源頁未明示幣別；需詢價確認。",
    unit: fields.unit,
...
const CNC_MACHINE_HOUR_SOURCE = {
  ...
  currencyEvidence: "EXPLICIT",
  currencyEvidenceNote: "來源機台費率表明示 TWD。",
  confidence: "MEDIUM",
...
const CNC_MARKETPLACE_SOURCE = {
  ...
  currencyEvidence: "EXPLICIT",
  currencyEvidenceNote: "來源頁面以 TWD/min 明示幣別。",
  confidence: "MEDIUM",
...
const LASER_MINCA_SOURCE = {
  ...
  currencyEvidence: "LOCALE_INFERRED",
  currencyEvidenceNote: "來源表格列示數值與每公尺／每孔，但檢查頁面未明示幣別；台灣網站語境僅作推定，需詢價確認。",
  confidence: "HIGH",
...
const LASER_ZHONGKAI_SOURCE = {
  ...
  sourceRole: "DIRECT_VENDOR_LISTED_PRICE",
  currencyEvidence: "LOCALE_INFERRED",
  currencyEvidenceNote: "來源頁面列示 `$` 數值與每米，但檢查頁面未明示幣別；台灣網站語境僅作推定，需詢價確認。",
  confidence: "HIGH",
...
function laserRow(source, material, thickness, price, smallHole = null) {
  return record({
    ...
    priceMax: price,
    currency: "TWD",
    currencyEvidence: source.currencyEvidence,
    currencyEvidenceNote: source.currencyEvidenceNote,
    unit: "TWD/m",
...
function validatePublicPriceReference(item) {
  ...
  if (!CURRENCY_EVIDENCE_VALUES.includes(item.currencyEvidence)) errors.push("invalid currencyEvidence");
  if (!item.currencyEvidenceNote) errors.push("currencyEvidenceNote is required");
  if (item.currencyEvidence === "EXPLICIT" && !item.currency) errors.push("EXPLICIT currency evidence requires currency");
  if (item.sourceRole === "NO_PUBLIC_PRICE_DATA" && item.currency !== null) errors.push("NO_PUBLIC_PRICE_DATA currency must be null");

...
async function refreshMachiningReference({ collector = collectPublicMachiningInputs, now = new Date(), weights, minimumEvidence, env, storageConfig, filePath, pool, storage } = {}) {

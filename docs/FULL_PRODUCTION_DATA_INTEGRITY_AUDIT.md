...
| MINCA laser table | `DIRECT_VENDOR_LISTED_PRICE` | Accepted with high confidence | Direct material/thickness per-meter table and explicit small-hole rule |
| Zhongkai laser service page | `DIRECT_VENDOR_LISTED_PRICE` | Accepted with high confidence | Direct per-meter table for three materials; unlisted small-hole fee remains null |
